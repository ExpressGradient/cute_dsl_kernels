...
def gemm_kernel(
    ...
    sA_layout = cute.tile_to_shape(sA_layout_atom, (128, 32), (0, 1))
    ...
    sB_layout = cute.tile_to_shape(sB_layout_atom, (128, 32), (0, 1))
    ...
    for k_tile in range(num_k_tiles):
        # Load tiles from Gmem to Smem with 128-bit copies
        cute.copy(g2s_copy_A, tAgA[None, None, None, k_tile], tAsA)
        cute.copy(g2s_copy_B, tBgB[None, None, None, k_tile], tBsB)
        ...
        cute.copy(s2r_copy_A, tCsA_copy, tCrA_copy)
        cute.copy(s2r_copy_B, tCsB_copy, tCrB_copy)
        ...
        # No overwriting to Smem until every warp has done GEMM
        cute.arch.sync_threads()
